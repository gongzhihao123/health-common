...
export default {
  ...
  watch: {
    ...
    studentExam () {
      ...
      this.list = data
      if (data.filter(item => item.projectName === '体成分').length === 0 || !data.filter(item => item.projectName === '体成分')[0].myProjectFlag) {
        this.tcfList = [' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ']
        this.tcfShow = false
      } else {
        this.tcfShow = true
      ...
      if (data.filter(item => item.projectName === '屈光度').length === 0 || !data.filter(item => item.projectName === '屈光度')[0].myProjectFlag) {
        this.qgdList = [' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ']
        this.qgdShow = false
      } else {
        this.qgdShow = true
